...
const Calculator= {
    ...
    Display_Value: '0',
    // this will hold the first operand for any expressions, we set it to hold null for now
    First_Operand: null,
    // this checks for second operand
...
function Handle_Operator(Next_Operator) {
    ...
    } else if (operator) { // checks for an already existing
